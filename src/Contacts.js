function Contacts() {
    ...
    return (
        <address className='contacts'>
            <h3 className='contactTitle'>Контактна інформация</h3>
            <div className='contactData'>
                <p className='contactText'>Телефон:<a href='tel:+380000000000'>+380 00 000 00 00</a></p>
                <p className='contactText'>Пошта:<a href='mailto:banderogus@email.com'>banderogus@email.com</a></p>
                <p className='contactText'>Адрес:<a href={addressMap}>Київ, м-н Незалежності, 16</a></p>
            </div>
        </address>
    )
}
